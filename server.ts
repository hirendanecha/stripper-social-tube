...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'tube-dist/stripper-social-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'tube-dist/stripper-social-tube/browser'), 'index.html')
    )
    .toString();
